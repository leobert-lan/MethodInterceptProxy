...
package osp.leobert.android.proxy.dx;
...
public final class TypeId<T> {
    ...
    public static final TypeId<Boolean> BOOLEAN
            = new TypeId<Boolean>(osp.leobert.android.proxy.dx.rop.type.Type.BOOLEAN);

    /** The {@code byte} primitive type. */
    public static final TypeId<Byte> BYTE = new TypeId<Byte>(osp.leobert.android.proxy.dx.rop.type.Type.BYTE);

    /** The {@code char} primitive type. */
    public static final TypeId<Character> CHAR
            = new TypeId<Character>(osp.leobert.android.proxy.dx.rop.type.Type.CHAR);

    /** The {@code double} primitive type. */
    public static final TypeId<Double> DOUBLE = new TypeId<Double>(osp.leobert.android.proxy.dx.rop.type.Type.DOUBLE);

    /** The {@code float} primitive type. */
    public static final TypeId<Float> FLOAT = new TypeId<Float>(osp.leobert.android.proxy.dx.rop.type.Type.FLOAT);

    /** The {@code int} primitive type. */
    public static final TypeId<Integer> INT = new TypeId<Integer>(osp.leobert.android.proxy.dx.rop.type.Type.INT);

    /** The {@code long} primitive type. */
    public static final TypeId<Long> LONG = new TypeId<Long>(osp.leobert.android.proxy.dx.rop.type.Type.LONG);

    /** The {@code short} primitive type. */
    public static final TypeId<Short> SHORT = new TypeId<Short>(osp.leobert.android.proxy.dx.rop.type.Type.SHORT);

    /** The {@code void} primitive type. Only used as a return type. */
    public static final TypeId<Void> VOID = new TypeId<Void>(osp.leobert.android.proxy.dx.rop.type.Type.VOID);

    /** The {@code Object} type. */
    public static final TypeId<Object> OBJECT = new TypeId<Object>(osp.leobert.android.proxy.dx.rop.type.Type.OBJECT);

    /** The {@code String} type. */
    public static final TypeId<String> STRING = new TypeId<String>(osp.leobert.android.proxy.dx.rop.type.Type.STRING);
    ...
    final osp.leobert.android.proxy.dx.rop.type.Type ropType;
    final CstType constant;

    TypeId(osp.leobert.android.proxy.dx.rop.type.Type ropType) {
        this(ropType.getDescriptor(), ropType);
    }

    TypeId(String name, osp.leobert.android.proxy.dx.rop.type.Type ropType) {
    ...
    public static <T> TypeId<T> get(String name) {
        return new TypeId<T>(name, osp.leobert.android.proxy.dx.rop.type.Type.internReturnType(name));
    }
