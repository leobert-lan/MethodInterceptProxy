...
import static osp.leobert.android.proxy.dx.rop.code.Rop.BRANCH_GOTO;
import static osp.leobert.android.proxy.dx.rop.code.Rop.BRANCH_NONE;
import static osp.leobert.android.proxy.dx.rop.code.Rop.BRANCH_RETURN;
import static osp.leobert.android.proxy.dx.rop.type.Type.BT_BYTE;
import static osp.leobert.android.proxy.dx.rop.type.Type.BT_CHAR;
import static osp.leobert.android.proxy.dx.rop.type.Type.BT_INT;
import static osp.leobert.android.proxy.dx.rop.type.Type.BT_SHORT;
...
public final class Code {
   ...
   public <D, V> void iput(FieldId<D, V> fieldId, Local<D> instance, Local<V> source) {
    ...
    private Rop getCastRop(osp.leobert.android.proxy.dx.rop.type.Type sourceType,
                           osp.leobert.android.proxy.dx.rop.type.Type targetType) {
