...
import osp.leobert.android.proxy.dx.util.MutabilityControl;

/**
 * Container for local variable information for a particular {@link
 * osp.leobert.android.proxy.dx.ssa.SsaMethod}.
 * Stolen from {@link osp.leobert.android.proxy.dx.rop.code.LocalVariableInfo}.
 */
public class LocalVariableInfo         extends MutabilityControl {
    ...
    /**
     * {@code non-null;} {@link osp.leobert.android.proxy.dx.rop.code.RegisterSpecSet} to use when indicating a block
     ...
     * {@link osp.leobert.android.proxy.dx.rop.type.TypeBearer} (such as a constant value).
     *
